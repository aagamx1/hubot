...
#   hubot j(enkins) list <filter> - lists Jenkins jobs
#   hubot j(enkins) describe <job> - Describes the specified Jenkins job
#   hubot j(enkins) last <job> - Details about the last build for the specified Jenkins job
